...
WARMUP="${HOLYSHT_PROFILE_WARMUP:-10}"
ITERS="${HOLYSHT_PROFILE_ITERS:-20}"
MAX_ALLOC_GIB="${HOLYSHT_PROFILE_MAX_ALLOC_GIB:-6}"
OUTPUT_STEM="${HOLYSHT_PROFILE_OUTPUT_STEM:-holysht_${SCENARIOS//,/__}_nsys}"
